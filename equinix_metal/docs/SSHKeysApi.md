...
# **create_ssh_key**
> SSHKey create_ssh_key(ssh_key_create_input=ssh_key_create_input)
...
with equinix_metal.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = equinix_metal.SSHKeysApi(api_client)
    ssh_key_create_input = equinix_metal.SSHKeyCreateInput() # SSHKeyCreateInput |  (optional)

    try:
        # Create a ssh key for the current user
        api_response = api_instance.create_ssh_key(ssh_key_create_input=ssh_key_create_input)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **ssh_key_create_input** | [**SSHKeyCreateInput**](SSHKeyCreateInput.md)|  | [optional] 
