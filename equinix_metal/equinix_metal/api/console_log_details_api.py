...
class ConsoleLogDetailsApi(object):
    ...
    def capture_screenshot(self, id : Annotated[StrictStr, Field(..., description="Device UUID")], **kwargs) -> bytearray:  # noqa: E501
        ...
        >>> thread = api.capture_screenshot(id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the capture_screenshot_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def capture_screenshot_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Device UUID")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.capture_screenshot_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method capture_screenshot" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _header_params['Accept'] = self.api_client.select_header_accept(
            ['application/jpeg', 'application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/devices/{id}/diagnostics/screenshot', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
