...
class PaymentMethodUpdateInput(BaseModel):
    ...
    __properties = ["billing_address", "cardholder_name", "default", "expiration_month", "expiration_year", "href", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentMethodUpdateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentMethodUpdateInput:
        """Create an instance of PaymentMethodUpdateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentMethodUpdateInput.parse_obj(obj)

        _obj = PaymentMethodUpdateInput.parse_obj({
