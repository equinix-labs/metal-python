...
class BatchesList(BaseModel):
    ...
    BatchesList
    """
    batches: Optional[conlist(Batch)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BatchesList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BatchesList:
        """Create an instance of BatchesList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BatchesList.parse_obj(obj)

        _obj = BatchesList.parse_obj({
