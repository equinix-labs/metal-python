...
class Storage(BaseModel):
    ...
    filesystems: Optional[conlist(Filesystem)] = None
    href: Optional[StrictStr] = None
    raid: Optional[conlist(Raid)] = None
    __properties = ["disks", "filesystems", "href", "raid"]
    ...
    def from_dict(cls, obj: dict) -> Storage:
        ...
        _obj = Storage.parse_obj({
            ...
            "filesystems": [Filesystem.from_dict(_item) for _item in obj.get("filesystems")] if obj.get("filesystems") is not None else None,
            "href": obj.get("href"),
            "raid": [Raid.from_dict(_item) for _item in obj.get("raid")] if obj.get("raid") is not None else None
        })
        return _obj
