...
class MetadataNetworkNetwork(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MetadataNetworkNetwork:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MetadataNetworkNetwork:
        """Create an instance of MetadataNetworkNetwork from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MetadataNetworkNetwork.parse_obj(obj)

        _obj = MetadataNetworkNetwork.parse_obj({
            "bonding": MetadataNetworkNetworkBonding.from_dict(obj.get("bonding")) if obj.get("bonding") is not None else None,
            "href": obj.get("href")
        })
        return _obj
