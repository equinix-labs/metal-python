...
class HardwareReservationsApi(object):
    ...
    @validate_arguments
    def activate_hardware_reservation(self, id : Annotated[StrictStr, Field(..., description="Hardware Reservation UUID")], activate_hardware_reservation_request : Annotated[Optional[ActivateHardwareReservationRequest], Field(description="Note to attach to the reservation")] = None, **kwargs) -> HardwareReservation:  # noqa: E501
        ...
        >>> thread = api.activate_hardware_reservation(id, activate_hardware_reservation_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.activate_hardware_reservation_with_http_info(id, activate_hardware_reservation_request, **kwargs)  # noqa: E501

    @validate_arguments
    def activate_hardware_reservation_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Hardware Reservation UUID")], activate_hardware_reservation_request : Annotated[Optional[ActivateHardwareReservationRequest], Field(description="Note to attach to the reservation")] = None, **kwargs):  # noqa: E501
        """Activate a spare hardware reservation  # noqa: E501
        ...
        >>> thread = api.activate_hardware_reservation_with_http_info(id, activate_hardware_reservation_request, async_req=True)
        >>> result = thread.get()
        ...
        _body_params = None
        if _params['activate_hardware_reservation_request']:
    ...
    @validate_arguments
    def find_hardware_reservation_by_id(self, id : Annotated[StrictStr, Field(..., description="HardwareReservation UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> HardwareReservation:  # noqa: E501
    ...
    @validate_arguments
    def find_hardware_reservation_by_id_with_http_info(self, id : Annotated[StrictStr, Field(..., description="HardwareReservation UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs):  # noqa: E501
        """Retrieve a hardware reservation  # noqa: E501
    ...
    @validate_arguments
    def move_hardware_reservation(self, id : Annotated[StrictStr, Field(..., description="Hardware Reservation UUID")], move_hardware_reservation_request : Annotated[MoveHardwareReservationRequest, Field(..., description="Destination Project UUID")], **kwargs) -> HardwareReservation:  # noqa: E501
    ...
    @validate_arguments
    def move_hardware_reservation_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Hardware Reservation UUID")], move_hardware_reservation_request : Annotated[MoveHardwareReservationRequest, Field(..., description="Destination Project UUID")], **kwargs):  # noqa: E501
        """Move a hardware reservation  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['move_hardware_reservation_request']:
