...
class License(BaseModel):
    ...
    __properties = ["description", "href", "id", "license_key", "licensee_product", "project", "size"]
    ...
    def from_dict(cls, obj: dict) -> License:
        ...
        _obj = License.parse_obj({
            ...
            "licensee_product": Href.from_dict(obj.get("licensee_product")) if obj.get("licensee_product") is not None else None,
