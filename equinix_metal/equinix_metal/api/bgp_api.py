...
class BGPApi(object):
    ...
    @validate_arguments
    def delete_bgp_session_with_http_info(self, id : Annotated[StrictStr, Field(..., description="BGP session UUID")], **kwargs):  # noqa: E501
        """Delete the BGP session  # noqa: E501
    ...
    @validate_arguments
    def find_global_bgp_ranges_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], **kwargs):  # noqa: E501
        """Retrieve all global bgp ranges  # noqa: E501
    ...
    @validate_arguments
    def find_project_bgp_sessions_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], **kwargs):  # noqa: E501
        """Retrieve all BGP sessions for project  # noqa: E501
    ...
    @validate_arguments
    def request_bgp_config_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], bgp_config_request_input : Annotated[BgpConfigRequestInput, Field(..., description="BGP config Request to create")], **kwargs):  # noqa: E501
        """Requesting bgp config  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['bgp_config_request_input']:
    ...
    @validate_arguments
    def update_bgp_session_with_http_info(self, id : Annotated[StrictStr, Field(..., description="BGP session UUID")], body : Annotated[StrictBool, Field(..., description="Default route")], **kwargs):  # noqa: E501
        """Update the BGP session  # noqa: E501
