# equinix_metal_t0mk.SpotMarketApi
...
with equinix_metal_t0mk.ApiClient(configuration) as api_client:
    ...
    api_instance = equinix_metal_t0mk.SpotMarketApi(api_client)
    id = 'id_example' # str | Project UUID
    spot_market_request_create_input = equinix_metal_t0mk.SpotMarketRequestCreateInput() # SpotMarketRequestCreateInput | Spot Market Request to create
