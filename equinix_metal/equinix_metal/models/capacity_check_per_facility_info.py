...
class CapacityCheckPerFacilityInfo(BaseModel):
    ...
    __properties = ["available", "facility", "href", "plan", "quantity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CapacityCheckPerFacilityInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CapacityCheckPerFacilityInfo:
        """Create an instance of CapacityCheckPerFacilityInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CapacityCheckPerFacilityInfo.parse_obj(obj)

        _obj = CapacityCheckPerFacilityInfo.parse_obj({
