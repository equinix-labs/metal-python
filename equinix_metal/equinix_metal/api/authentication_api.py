...
class AuthenticationApi(object):
    ...
    @validate_arguments
    def create_api_key(self, auth_token_input : Annotated[AuthTokenInput, Field(..., description="API key to create")], **kwargs) -> AuthToken:  # noqa: E501
    ...
    @validate_arguments
    def create_api_key_with_http_info(self, auth_token_input : Annotated[AuthTokenInput, Field(..., description="API key to create")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create an API key  # noqa: E501
    ...
    @validate_arguments
    def create_project_api_key(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], auth_token_input : Annotated[AuthTokenInput, Field(..., description="API Key to create")], **kwargs) -> AuthToken:  # noqa: E501
    ...
    @validate_arguments
    def create_project_api_key_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], auth_token_input : Annotated[AuthTokenInput, Field(..., description="API Key to create")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create an API key for a project.  # noqa: E501
    ...
    def find_api_keys(self, include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> AuthTokenList:  # noqa: E501
        ...
        >>> thread = api.find_api_keys(include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        return self.find_api_keys_with_http_info(include, exclude, **kwargs)  # noqa: E501
    ...
    def find_api_keys_with_http_info(self, include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.find_api_keys_with_http_info(include, exclude, async_req=True)
        >>> result = thread.get()
    ...
    def find_project_api_keys(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> AuthTokenList:  # noqa: E501
        ...
        >>> thread = api.find_project_api_keys(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        return self.find_project_api_keys_with_http_info(id, include, exclude, **kwargs)  # noqa: E501
    ...
    def find_project_api_keys_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.find_project_api_keys_with_http_info(id, include, exclude, async_req=True)
        >>> result = thread.get()
