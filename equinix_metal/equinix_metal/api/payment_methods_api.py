...
class PaymentMethodsApi(object):
    ...
    @validate_arguments
    def delete_payment_method_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Payment Method UUID")], **kwargs):  # noqa: E501
        """Delete the payment method  # noqa: E501
    ...
    @validate_arguments
    def update_payment_method_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Payment Method UUID")], payment_method_update_input : Annotated[PaymentMethodUpdateInput, Field(..., description="Payment Method to update")], **kwargs):  # noqa: E501
        """Update the payment method  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['payment_method_update_input']:
