...
class UserLimited(BaseModel):
    ...
    avatar_url: Optional[StrictStr] = Field(None, description="Avatar URL of the User")
    ...
    __properties = ["avatar_thumb_url", "avatar_url", "full_name", "href", "id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserLimited:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserLimited:
        """Create an instance of UserLimited from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserLimited.parse_obj(obj)

        _obj = UserLimited.parse_obj({
