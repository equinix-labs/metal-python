...
class CapacityApi(object):
    ...
    @validate_arguments
    def check_capacity_for_facility_with_http_info(self, capacity_input : Annotated[CapacityInput, Field(..., description="Facility to check capacity in")], **kwargs):  # noqa: E501
        """Check capacity  # noqa: E501
    ...
    @validate_arguments
    def check_capacity_for_metro_with_http_info(self, capacity_per_metro_input : Annotated[CapacityPerMetroInput, Field(..., description="Metro to check capacity in")], **kwargs):  # noqa: E501
        """Check capacity for a metro  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['capacity_per_metro_input']:
    ...
    @validate_arguments
    def find_organization_capacity_per_facility_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Organization UUID")], **kwargs):  # noqa: E501
        """View available hardware plans per Facility for given organization  # noqa: E501
    ...
    @validate_arguments
    def find_organization_capacity_per_metro_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Organization UUID")], **kwargs):  # noqa: E501
        """View available hardware plans per Metro for given organization  # noqa: E501
