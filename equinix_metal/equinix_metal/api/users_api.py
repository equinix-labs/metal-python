...
class UsersApi(object):
    ...
    @validate_arguments
    def create_user_with_http_info(self, user_create_input : Annotated[UserCreateInput, Field(..., description="User to create")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a user  # noqa: E501
    ...
    @validate_arguments
    def update_current_user_with_http_info(self, user_update_input : Annotated[UserUpdateInput, Field(..., description="User to update")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update the current user  # noqa: E501
