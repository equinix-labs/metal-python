...
class VLANsApi(object):
    ...
    def create_virtual_network_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], virtual_network_create_input : Annotated[VirtualNetworkCreateInput, Field(..., description="Virtual Network to create")], **kwargs):  # noqa: E501
        ...
        _body_params = None
        if _params['virtual_network_create_input']:
    ...
    @validate_arguments
    def delete_virtual_network_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Virtual Network UUID")], **kwargs):  # noqa: E501
        """Delete a virtual network  # noqa: E501
    ...
    @validate_arguments
    def get_virtual_network_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Virtual Network UUID")], **kwargs):  # noqa: E501
        """Get a virtual network  # noqa: E501
