...
class SpotMarketRequestCreateInputInstanceParameters(BaseModel):
    ...
    user_ssh_keys: Optional[conlist(StrictStr)] = Field(None, description="The UUIDs of users whose SSH keys should be included on the provisioned device.")
    userdata: Optional[StrictStr] = None
    __properties = ["always_pxe", "billing_cycle", "customdata", "description", "features", "hostname", "hostnames", "href", "locked", "no_ssh_keys", "operating_system", "plan", "private_ipv4_subnet_size", "project_ssh_keys", "public_ipv4_subnet_size", "tags", "termination_time", "user_ssh_keys", "userdata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotMarketRequestCreateInputInstanceParameters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotMarketRequestCreateInputInstanceParameters:
        """Create an instance of SpotMarketRequestCreateInputInstanceParameters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotMarketRequestCreateInputInstanceParameters.parse_obj(obj)

        _obj = SpotMarketRequestCreateInputInstanceParameters.parse_obj({
