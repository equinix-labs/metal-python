...
import metal_python
from metal_python.models.device_list import DeviceList  # noqa: E501
...
class TestDeviceList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = metal_python.models.device_list.DeviceList()  # noqa: E501
        if include_optional :
            return DeviceList(
                devices = [
                    metal_python.models.device.Device(
                        always_pxe = True, 
                        billing_cycle = '', 
                        bonding_mode = 56, 
