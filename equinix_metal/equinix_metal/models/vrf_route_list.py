...
class VrfRouteList(BaseModel):
    ...
    routes: Optional[conlist(VrfRoute)] = None
    __properties = ["href", "meta", "routes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VrfRouteList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VrfRouteList:
        """Create an instance of VrfRouteList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VrfRouteList.parse_obj(obj)

        _obj = VrfRouteList.parse_obj({
            "href": obj.get("href"),
            "meta": Meta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "routes": [VrfRoute.from_dict(_item) for _item in obj.get("routes")] if obj.get("routes") is not None else None
        })
        return _obj
