...
class VerifyEmail(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerifyEmail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VerifyEmail:
        """Create an instance of VerifyEmail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VerifyEmail.parse_obj(obj)

        _obj = VerifyEmail.parse_obj({
            "href": obj.get("href"),
