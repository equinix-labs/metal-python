...
class HardwareReservationsApi(object):
    ...
    @validate_arguments
    def activate_hardware_reservation_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Hardware Reservation UUID")], activate_hardware_reservation_request : Annotated[Optional[ActivateHardwareReservationRequest], Field(description="Note to attach to the reservation")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Activate a spare hardware reservation  # noqa: E501
    ...
    @validate_arguments
    def move_hardware_reservation_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Hardware Reservation UUID")], move_hardware_reservation_request : Annotated[MoveHardwareReservationRequest, Field(..., description="Destination Project UUID")], **kwargs) -> ApiResponse:  # noqa: E501
        """Move a hardware reservation  # noqa: E501
