...
class VrfMetalGatewayCreateInput(BaseModel):
    ...
    __properties = ["href", "ip_reservation_id", "virtual_network_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VrfMetalGatewayCreateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VrfMetalGatewayCreateInput:
        """Create an instance of VrfMetalGatewayCreateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VrfMetalGatewayCreateInput.parse_obj(obj)

        _obj = VrfMetalGatewayCreateInput.parse_obj({
            "href": obj.get("href"),
