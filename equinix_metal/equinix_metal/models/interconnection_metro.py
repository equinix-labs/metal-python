...
class InterconnectionMetro(BaseModel):
    """
    ...
    __properties = ["code", "country", "href", "id", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterconnectionMetro:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterconnectionMetro:
        """Create an instance of InterconnectionMetro from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return InterconnectionMetro.parse_obj(obj)

        _obj = InterconnectionMetro.parse_obj({
            "code": obj.get("code"),
