...
class HardwareReservationsApi(object):
    ...
    @validate_arguments
    def activate_hardware_reservation_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Hardware Reservation UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, activate_hardware_reservation_request : Annotated[Optional[ActivateHardwareReservationRequest], Field(description="Note to attach to the reservation")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Activate a spare hardware reservation  # noqa: E501
