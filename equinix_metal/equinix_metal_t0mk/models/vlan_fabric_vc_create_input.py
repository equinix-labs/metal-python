...
class VlanFabricVcCreateInput(BaseModel):
    ...
    vlans: Optional[conlist(StrictInt)] = Field(None, description="A list of one or two metro-based VLANs that will be set on the virtual circuits of primary and/or secondary (if redundant) interconnections respectively when creating Fabric VCs. VLANs can also be set after the interconnection is created, but are required to fully activate the virtual circuits.")
    __properties = ["contact_email", "description", "href", "metro", "name", "project", "redundancy", "service_token_type", "speed", "tags", "type", "vlans"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VlanFabricVcCreateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VlanFabricVcCreateInput:
        """Create an instance of VlanFabricVcCreateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VlanFabricVcCreateInput.parse_obj(obj)

        _obj = VlanFabricVcCreateInput.parse_obj({
