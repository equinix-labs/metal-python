...
class OperatingSystemList(BaseModel):
    ...
    operating_systems: Optional[conlist(OperatingSystem)] = None
    __properties = ["href", "operating_systems"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OperatingSystemList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OperatingSystemList:
        """Create an instance of OperatingSystemList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OperatingSystemList.parse_obj(obj)

        _obj = OperatingSystemList.parse_obj({
            "href": obj.get("href"),
            "operating_systems": [OperatingSystem.from_dict(_item) for _item in obj.get("operating_systems")] if obj.get("operating_systems") is not None else None
        })
        return _obj
