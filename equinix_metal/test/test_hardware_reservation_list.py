...
from equinix_metal_t0mk.models.hardware_reservation_list import HardwareReservationList  # noqa: E501
...
class TestHardwareReservationList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = equinix_metal_t0mk.models.hardware_reservation_list.HardwareReservationList()  # noqa: E501
        if include_optional :
            return HardwareReservationList(
                hardware_reservations = [
                    equinix_metal_t0mk.models.hardware_reservation.HardwareReservation(
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        custom_rate = 1050.5, 
                        device = equinix_metal_t0mk.models.device.Device(
                            actions = [
                                equinix_metal_t0mk.models.device_actions_inner.Device_actions_inner(
                                    href = '', 
                                    name = '', 
                                    type = '', )
                                ], 
                            ...
                            customdata = { }, 
                            description = '', 
                            facility = equinix_metal_t0mk.models.facility.Facility(
                                ...
                                name = '', ), 
                            firmware_set_id = '', 
                            hardware_reservation = equinix_metal_t0mk.models.hardware_reservation.HardwareReservation(
                                created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                custom_rate = 1050.5, 
                                href = '', 
                                id = '', 
                            ...
                            image_url = '', 
                            ip_addresses = [
                                equinix_metal_t0mk.models.ip_assignment.IPAssignment(
                                    address_family = 56, 
                                    assigned_to = , 
                                    cidr = 56, 
                                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            ...
                            network_frozen = True, 
                            network_ports = [
                                equinix_metal_t0mk.models.port.Port(
                            ...
                            operating_system = equinix_metal_t0mk.models.operating_system.OperatingSystem(
                            ...
                            project_lite = null, 
                            provisioning_events = [
                                equinix_metal_t0mk.models.event.Event(
                                    body = '', 
                                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                    href = '', 
                                    id = '', 
