...
with metal_python.ApiClient(configuration) as api_client:
    ...
    api_instance = metal_python.DevicesApi(api_client)
    id = 'id_example' # str | Project UUID
    create_device_request = metal_python.CreateDeviceRequest() # CreateDeviceRequest | Device to create
...
with metal_python.ApiClient(configuration) as api_client:
    ...
    ip_assignment_input = metal_python.IPAssignmentInput() # IPAssignmentInput | IPAssignment to create
...
with metal_python.ApiClient(configuration) as api_client:
    ...
    api_instance = metal_python.DevicesApi(api_client)
    id = 'id_example' # str | Device UUID
    device_update_input = metal_python.DeviceUpdateInput() # DeviceUpdateInput | Facility to update
