...
class SpotMarketRequestCreateInput(BaseModel):
    ...
    facilities: Optional[conlist(StrictStr)] = None
    href: Optional[StrictStr] = None
    instance_parameters: Optional[SpotMarketRequestCreateInputInstanceParameters] = None
    max_bid_price: Optional[StrictFloat] = None
    metro: Optional[StrictStr] = Field(None, description="The metro ID or code the spot market request will be created in.")
    __properties = ["devices_max", "devices_min", "end_at", "facilities", "href", "instance_parameters", "max_bid_price", "metro"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotMarketRequestCreateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotMarketRequestCreateInput:
        """Create an instance of SpotMarketRequestCreateInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SpotMarketRequestCreateInput.parse_obj(obj)

        _obj = SpotMarketRequestCreateInput.parse_obj({
            "devices_max": obj.get("devices_max"),
            "devices_min": obj.get("devices_min"),
            "end_at": obj.get("end_at"),
            "facilities": obj.get("facilities"),
            "href": obj.get("href"),
            "instance_parameters": SpotMarketRequestCreateInputInstanceParameters.from_dict(obj.get("instance_parameters")) if obj.get("instance_parameters") is not None else None,
