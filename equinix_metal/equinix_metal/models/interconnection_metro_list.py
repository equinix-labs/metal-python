...
class InterconnectionMetroList(BaseModel):
    ...
    metros: Optional[conlist(InterconnectionMetroListMetrosInner)] = None
    __properties = ["href", "meta", "metros"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterconnectionMetroList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterconnectionMetroList:
        """Create an instance of InterconnectionMetroList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InterconnectionMetroList.parse_obj(obj)

        _obj = InterconnectionMetroList.parse_obj({
            "href": obj.get("href"),
            "meta": Meta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "metros": [InterconnectionMetroListMetrosInner.from_dict(_item) for _item in obj.get("metros")] if obj.get("metros") is not None else None
        })
        return _obj
