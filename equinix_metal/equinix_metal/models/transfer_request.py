...
class TransferRequest(BaseModel):
    ...
    __properties = ["created_at", "href", "id", "project", "target_organization", "updated_at"]
    ...
    def from_dict(cls, obj: dict) -> TransferRequest:
        ...
        _obj = TransferRequest.parse_obj({
            ...
            "target_organization": Href.from_dict(obj.get("target_organization")) if obj.get("target_organization") is not None else None,
