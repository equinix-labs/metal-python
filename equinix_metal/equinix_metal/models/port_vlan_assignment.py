...
class PortVlanAssignment(BaseModel):
    ...
    __properties = ["created_at", "href", "id", "native", "port", "state", "updated_at", "virtual_network", "vlan"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in ('assigned', 'unassigning'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortVlanAssignment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortVlanAssignment:
        """Create an instance of PortVlanAssignment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortVlanAssignment.parse_obj(obj)

        _obj = PortVlanAssignment.parse_obj({
