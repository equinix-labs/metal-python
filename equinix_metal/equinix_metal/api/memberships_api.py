...
class MembershipsApi(object):
    ...
    def delete_membership(self, id : Annotated[StrictStr, Field(..., description="Membership UUID")], **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_membership_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_membership" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def find_membership_by_id(self, id : Annotated[StrictStr, Field(..., description="Membership UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> Membership:  # noqa: E501
        ...
        >>> thread = api.find_membership_by_id(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the find_membership_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.find_membership_by_id_with_http_info(id, include, exclude, **kwargs)  # noqa: E501
    ...
    def find_membership_by_id_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Membership UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.find_membership_by_id_with_http_info(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_membership_by_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def update_membership(self, id : Annotated[StrictStr, Field(..., description="Membership UUID")], membership_input : Annotated[MembershipInput, Field(..., description="Membership to update")], **kwargs) -> Membership:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the update_membership_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.update_membership_with_http_info(id, membership_input, **kwargs)  # noqa: E501

    @validate_arguments
    def update_membership_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Membership UUID")], membership_input : Annotated[MembershipInput, Field(..., description="Membership to update")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update the membership  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_membership" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['membership_input'] is not None:
            _body_params = _params['membership_input']
