...
class LicensesApi(object):
    ...
    @validate_arguments
    def create_license(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], license_create_input : Annotated[LicenseCreateInput, Field(..., description="License to create")], **kwargs) -> License:  # noqa: E501
    ...
    @validate_arguments
    def create_license_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Project UUID")], license_create_input : Annotated[LicenseCreateInput, Field(..., description="License to create")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a License  # noqa: E501
    ...
    @validate_arguments
    def update_license(self, id : Annotated[StrictStr, Field(..., description="License UUID")], license_update_input : Annotated[LicenseUpdateInput, Field(..., description="License to update")], **kwargs) -> License:  # noqa: E501
    ...
    @validate_arguments
    def update_license_with_http_info(self, id : Annotated[StrictStr, Field(..., description="License UUID")], license_update_input : Annotated[LicenseUpdateInput, Field(..., description="License to update")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update the license  # noqa: E501
