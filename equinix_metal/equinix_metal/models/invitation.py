...
class Invitation(BaseModel):
    ...
    __properties = ["created_at", "href", "id", "invitation", "invited_by", "invitee", "nonce", "organization", "projects", "roles", "updated_at"]
    ...
    def from_dict(cls, obj: dict) -> Invitation:
        ...
        _obj = Invitation.parse_obj({
            ...
            "href": obj.get("href"),
            "id": obj.get("id"),
            "invitation": Href.from_dict(obj.get("invitation")) if obj.get("invitation") is not None else None,
            "invited_by": Href.from_dict(obj.get("invited_by")) if obj.get("invited_by") is not None else None,
