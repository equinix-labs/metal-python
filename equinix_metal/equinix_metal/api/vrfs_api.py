...
class VRFsApi(object):
    ...
    @validate_arguments
    def update_vrf(self, id : Annotated[StrictStr, Field(..., description="VRF UUID")], vrf_update_input : Annotated[VrfUpdateInput, Field(..., description="VRF to update")], **kwargs) -> Vrf:  # noqa: E501
