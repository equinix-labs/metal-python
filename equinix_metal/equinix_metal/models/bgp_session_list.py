...
class BgpSessionList(BaseModel):
    ...
    BgpSessionList
    """
    bgp_sessions: Optional[conlist(BgpSession)] = None
    href: Optional[StrictStr] = None
    __properties = ["bgp_sessions", "href"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BgpSessionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BgpSessionList:
        """Create an instance of BgpSessionList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BgpSessionList.parse_obj(obj)

        _obj = BgpSessionList.parse_obj({
            "bgp_sessions": [BgpSession.from_dict(_item) for _item in obj.get("bgp_sessions")] if obj.get("bgp_sessions") is not None else None,
            "href": obj.get("href")
        })
        return _obj
