...
class VirtualCircuitCreateInput(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[VlanVirtualCircuitCreateInput, VrfVirtualCircuitCreateInput]
    else:
        actual_instance: Any
    one_of_schemas: List[str] = Field(VIRTUALCIRCUITCREATEINPUT_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = VirtualCircuitCreateInput.construct()
        error_messages = []
        match = 0
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualCircuitCreateInput:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> VirtualCircuitCreateInput:
