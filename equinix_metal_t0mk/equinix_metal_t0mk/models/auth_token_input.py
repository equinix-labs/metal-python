...
class AuthTokenInput(BaseModel):
    ...
    __properties = ["description", "href", "read_only"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthTokenInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthTokenInput:
        """Create an instance of AuthTokenInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthTokenInput.parse_obj(obj)

        _obj = AuthTokenInput.parse_obj({
