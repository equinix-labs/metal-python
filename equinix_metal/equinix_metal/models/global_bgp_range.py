...
class GlobalBgpRange(BaseModel):
    ...
    __properties = ["address_family", "href", "id", "project", "range"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GlobalBgpRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GlobalBgpRange:
        """Create an instance of GlobalBgpRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GlobalBgpRange.parse_obj(obj)

        _obj = GlobalBgpRange.parse_obj({
