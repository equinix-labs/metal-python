...
class UserVerificationTokensApi(object):
    ...
    @validate_arguments
    def consume_verification_request_with_http_info(self, verify_email : Annotated[VerifyEmail, Field(..., description="Email to create")], **kwargs):  # noqa: E501
        """Verify a user using an email verification token  # noqa: E501
    ...
    @validate_arguments
    def create_validation_request_with_http_info(self, login : Annotated[StrictStr, Field(..., description="Email for verification request")], **kwargs):  # noqa: E501
        """Create an email verification request  # noqa: E501
