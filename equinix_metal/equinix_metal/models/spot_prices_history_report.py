...
class SpotPricesHistoryReport(BaseModel):
    ...
    __properties = ["href", "prices_history"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotPricesHistoryReport:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotPricesHistoryReport:
        """Create an instance of SpotPricesHistoryReport from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotPricesHistoryReport.parse_obj(obj)

        _obj = SpotPricesHistoryReport.parse_obj({
            "href": obj.get("href"),
            "prices_history": SpotPricesDatapoints.from_dict(obj.get("prices_history")) if obj.get("prices_history") is not None else None
        })
        return _obj
