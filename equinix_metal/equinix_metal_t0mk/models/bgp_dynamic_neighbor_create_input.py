...
class BgpDynamicNeighborCreateInput(BaseModel):
    ...
    __properties = ["bgp_neighbor_asn", "bgp_neighbor_range", "href", "tags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BgpDynamicNeighborCreateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BgpDynamicNeighborCreateInput:
        """Create an instance of BgpDynamicNeighborCreateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BgpDynamicNeighborCreateInput.parse_obj(obj)

        _obj = BgpDynamicNeighborCreateInput.parse_obj({
