...
class SelfServiceReservationsApi(object):
    ...
    @validate_arguments
    def create_self_service_reservation_with_http_info(self, project_id : Annotated[StrictStr, Field(..., description="Project UUID")], create_self_service_reservation_request : Annotated[CreateSelfServiceReservationRequest, Field(..., description="reservation to create")], **kwargs):  # noqa: E501
        """Create a reservation  # noqa: E501
        ...
        _body_params = None
        if _params['create_self_service_reservation_request']:
    ...
    @validate_arguments
    def find_self_service_reservation_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Reservation short_id")], project_id : Annotated[StrictStr, Field(..., description="Project UUID")], **kwargs):  # noqa: E501
        """Retrieve a reservation  # noqa: E501
