...
class PasswordResetTokensApi(object):
    ...
    @validate_arguments
    def create_password_reset_token_with_http_info(self, email : Annotated[StrictStr, Field(..., description="Email of user to create password reset token")], **kwargs):  # noqa: E501
        """Create a password reset token  # noqa: E501
