...
class PaymentMethodBillingAddress(BaseModel):
    ...
    __properties = ["country_code_alpha2", "href", "postal_code", "street_address"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentMethodBillingAddress:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentMethodBillingAddress:
        """Create an instance of PaymentMethodBillingAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentMethodBillingAddress.parse_obj(obj)

        _obj = PaymentMethodBillingAddress.parse_obj({
