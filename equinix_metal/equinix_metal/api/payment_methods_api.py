...
class PaymentMethodsApi(object):
    ...
    @validate_arguments
    def delete_payment_method(self, id : Annotated[StrictStr, Field(..., description="Payment Method UUID")], **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_payment_method_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.delete_payment_method_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_payment_method_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Payment Method UUID")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete the payment method  # noqa: E501
    ...
    @validate_arguments
    def find_payment_method_by_id(self, id : Annotated[StrictStr, Field(..., description="Payment Method UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> PaymentMethod:  # noqa: E501
        ...
        >>> thread = api.find_payment_method_by_id(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the find_payment_method_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.find_payment_method_by_id_with_http_info(id, include, exclude, **kwargs)  # noqa: E501
    ...
    def find_payment_method_by_id_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Payment Method UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.find_payment_method_by_id_with_http_info(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_payment_method_by_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def update_payment_method(self, id : Annotated[StrictStr, Field(..., description="Payment Method UUID")], payment_method_update_input : Annotated[PaymentMethodUpdateInput, Field(..., description="Payment Method to update")], **kwargs) -> PaymentMethod:  # noqa: E501
    ...
    @validate_arguments
    def update_payment_method_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Payment Method UUID")], payment_method_update_input : Annotated[PaymentMethodUpdateInput, Field(..., description="Payment Method to update")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update the payment method  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['payment_method_update_input'] is not None:
            _body_params = _params['payment_method_update_input']
