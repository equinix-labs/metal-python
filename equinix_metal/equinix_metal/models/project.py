...
class Project(BaseModel):
    ...
    __properties = ["bgp_config", "created_at", "customdata", "devices", "id", "invitations", "max_devices", "members", "memberships", "name", "network_status", "payment_method", "ssh_keys", "updated_at", "volumes", "organization", "href", "backend_transfer_enabled"]
