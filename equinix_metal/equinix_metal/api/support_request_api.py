...
class SupportRequestApi(object):
    ...
    def request_suppert(self, support_request_input : Annotated[SupportRequestInput, Field(..., description="Support Request to create")], **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the request_suppert_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def request_suppert_with_http_info(self, support_request_input : Annotated[SupportRequestInput, Field(..., description="Support Request to create")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method request_suppert" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['support_request_input'] is not None:
            _body_params = _params['support_request_input']
