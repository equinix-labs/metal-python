...
class PortVlanAssignmentBatchVlanAssignmentsInner(BaseModel):
    ...
    __properties = ["href", "id", "native", "state", "vlan"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortVlanAssignmentBatchVlanAssignmentsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortVlanAssignmentBatchVlanAssignmentsInner:
        """Create an instance of PortVlanAssignmentBatchVlanAssignmentsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortVlanAssignmentBatchVlanAssignmentsInner.parse_obj(obj)

        _obj = PortVlanAssignmentBatchVlanAssignmentsInner.parse_obj({
            "href": obj.get("href"),
            "id": obj.get("id"),
