...
import metal_python
from metal_python.models.device_create_in_facility_input import DeviceCreateInFacilityInput  # noqa: E501
...
class TestDeviceCreateInFacilityInput(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = metal_python.models.device_create_in_facility_input.DeviceCreateInFacilityInput()  # noqa: E501
        if include_optional :
            return DeviceCreateInFacilityInput(
                ...
                hostname = '', 
                ip_addresses = [
                    metal_python.models.device_create_input_ip_addresses_inner.DeviceCreateInput_ip_addresses_inner(
                        address_family = 4, 
                        cidr = 28, 
                        ip_reservations = [
                            ''
                ...
                spot_price_max = 1.23, 
                ssh_keys = [
                    metal_python.models.ssh_key_input.SSHKeyInput(
                        key = '', 
                        label = '', 
                        href = '', )
                    ], 
