...
class PasswordResetTokensApi(object):
    ...
    def create_password_reset_token(self, email : Annotated[StrictStr, Field(..., description="Email of user to create password reset token")], **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the create_password_reset_token_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_password_reset_token" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def reset_password(self, **kwargs) -> NewPassword:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the reset_password_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.reset_password_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def reset_password_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Reset current user password  # noqa: E501
