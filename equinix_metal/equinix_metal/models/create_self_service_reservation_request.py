...
class CreateSelfServiceReservationRequest(BaseModel):
    ...
    item: Optional[conlist(SelfServiceReservationItemRequest)] = None
    notes: Optional[StrictStr] = None
    period: Optional[CreateSelfServiceReservationRequestPeriod] = None
    start_date: Optional[datetime] = None
    __properties = ["href", "item", "notes", "period", "start_date"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSelfServiceReservationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSelfServiceReservationRequest:
        """Create an instance of CreateSelfServiceReservationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSelfServiceReservationRequest.parse_obj(obj)

        _obj = CreateSelfServiceReservationRequest.parse_obj({
            "href": obj.get("href"),
            "item": [SelfServiceReservationItemRequest.from_dict(_item) for _item in obj.get("item")] if obj.get("item") is not None else None,
            "notes": obj.get("notes"),
