...
class MetalGatewaysApi(object):
    ...
    @validate_arguments
    def create_metal_gateway_elastic_ip_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Metal Gateway UUID")], metal_gateway_elastic_ip_create_input : MetalGatewayElasticIpCreateInput, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a Metal Gateway Elastic IP  # noqa: E501
