...
class VlanVirtualCircuitCreateInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VlanVirtualCircuitCreateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VlanVirtualCircuitCreateInput:
        """Create an instance of VlanVirtualCircuitCreateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VlanVirtualCircuitCreateInput.parse_obj(obj)

        _obj = VlanVirtualCircuitCreateInput.parse_obj({
