...
class VirtualNetworkList(BaseModel):
    ...
    virtual_networks: Optional[conlist(VirtualNetwork)] = None
    __properties = ["href", "virtual_networks"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualNetworkList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualNetworkList:
        """Create an instance of VirtualNetworkList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VirtualNetworkList.parse_obj(obj)

        _obj = VirtualNetworkList.parse_obj({
            "href": obj.get("href"),
            "virtual_networks": [VirtualNetwork.from_dict(_item) for _item in obj.get("virtual_networks")] if obj.get("virtual_networks") is not None else None
        })
        return _obj
