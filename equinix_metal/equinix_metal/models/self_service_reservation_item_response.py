...
class SelfServiceReservationItemResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SelfServiceReservationItemResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SelfServiceReservationItemResponse:
        """Create an instance of SelfServiceReservationItemResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SelfServiceReservationItemResponse.parse_obj(obj)
