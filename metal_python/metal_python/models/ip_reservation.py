...
class IPReservation(BaseModel):
    ...
    type: StrictStr = ...
    __properties = ["addon", "address", "address_family", "assignments", "available", "bill", "cidr", "created_at", "customdata", "enabled", "details", "facility", "gateway", "global_ip", "href", "id", "manageable", "management", "metal_gateway", "metro", "netmask", "network", "project", "project_lite", "requested_by", "public", "state", "tags", "type"]
