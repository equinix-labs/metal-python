...
class SupportRequestApi(object):
    ...
    @validate_arguments
    def request_suppert_with_http_info(self, support_request_input : Annotated[SupportRequestInput, Field(..., description="Support Request to create")], **kwargs):  # noqa: E501
        """Create a support ticket  # noqa: E501
        ...
        _body_params = None
        if _params['support_request_input']:
