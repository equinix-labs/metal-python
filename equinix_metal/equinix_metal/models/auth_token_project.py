...
class AuthTokenProject(BaseModel):
    ...
    name: Optional[constr(strict=True, max_length=80, min_length=1)] = Field(None, description="The name of the project. Cannot contain characters encoded in greater than 3 bytes such as emojis.")
    ...
    type: Optional[StrictStr] = Field(None, description="The type of the project. Projects of type `vmce` are part of an in development feature and not available to all customers.")
    updated_at: Optional[datetime] = None
    volumes: Optional[conlist(Href)] = None
    __properties = ["backend_transfer_enabled", "bgp_config", "created_at", "customdata", "devices", "href", "id", "invitations", "max_devices", "members", "memberships", "name", "network_status", "organization", "payment_method", "ssh_keys", "tags", "type", "updated_at", "volumes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthTokenProject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthTokenProject:
        """Create an instance of AuthTokenProject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthTokenProject.parse_obj(obj)

        _obj = AuthTokenProject.parse_obj({
