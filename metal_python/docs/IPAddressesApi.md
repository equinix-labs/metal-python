...
with metal_python.ApiClient(configuration) as api_client:
    ...
    api_instance = metal_python.IPAddressesApi(api_client)
...
with metal_python.ApiClient(configuration) as api_client:
    ...
    api_instance = metal_python.IPAddressesApi(api_client)
    id = 'id_example' # str | Project UUID
    request_ip_reservation_request = metal_python.RequestIPReservationRequest() # RequestIPReservationRequest | IP Reservation Request to create
...
with metal_python.ApiClient(configuration) as api_client:
    ...
    api_instance = metal_python.IPAddressesApi(api_client)
    id = 'id_example' # str | IP Address UUID
    ip_assignment_update_input = metal_python.IPAssignmentUpdateInput() # IPAssignmentUpdateInput |  (optional)
