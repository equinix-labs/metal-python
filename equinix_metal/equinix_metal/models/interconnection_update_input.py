...
class InterconnectionUpdateInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterconnectionUpdateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterconnectionUpdateInput:
        """Create an instance of InterconnectionUpdateInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return InterconnectionUpdateInput.parse_obj(obj)

        _obj = InterconnectionUpdateInput.parse_obj({
