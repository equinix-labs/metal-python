...
class FirmwareSetResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FirmwareSetResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FirmwareSetResponse:
        """Create an instance of FirmwareSetResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FirmwareSetResponse.parse_obj(obj)

        _obj = FirmwareSetResponse.parse_obj({
            "href": obj.get("href"),
            "record": FirmwareSet.from_dict(obj.get("record")) if obj.get("record") is not None else None
        })
        return _obj
