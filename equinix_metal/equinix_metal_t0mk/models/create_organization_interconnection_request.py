...
class CreateOrganizationInterconnectionRequest(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = CreateOrganizationInterconnectionRequest.construct()
        error_messages = []
        match = 0
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrganizationInterconnectionRequest:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> CreateOrganizationInterconnectionRequest:
