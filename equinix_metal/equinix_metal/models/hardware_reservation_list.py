...
class HardwareReservationList(BaseModel):
    ...
    """
    hardware_reservations: Optional[conlist(HardwareReservation)] = None
    href: Optional[StrictStr] = None
    meta: Optional[Meta] = None
    __properties = ["hardware_reservations", "href", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HardwareReservationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HardwareReservationList:
        """Create an instance of HardwareReservationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HardwareReservationList.parse_obj(obj)

        _obj = HardwareReservationList.parse_obj({
            "hardware_reservations": [HardwareReservation.from_dict(_item) for _item in obj.get("hardware_reservations")] if obj.get("hardware_reservations") is not None else None,
            "href": obj.get("href"),
