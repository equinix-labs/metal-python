...
class MetalGatewayList(BaseModel):
    ...
    metal_gateways: Optional[conlist(MetalGatewayListMetalGatewaysInner)] = None
    __properties = ["href", "meta", "metal_gateways"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MetalGatewayList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MetalGatewayList:
        """Create an instance of MetalGatewayList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MetalGatewayList.parse_obj(obj)

        _obj = MetalGatewayList.parse_obj({
            "href": obj.get("href"),
            "meta": Meta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "metal_gateways": [MetalGatewayListMetalGatewaysInner.from_dict(_item) for _item in obj.get("metal_gateways")] if obj.get("metal_gateways") is not None else None
        })
        return _obj
