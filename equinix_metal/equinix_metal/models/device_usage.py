...
class DeviceUsage(BaseModel):
    ...
    __properties = ["href", "quantity", "total", "unit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeviceUsage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeviceUsage:
        """Create an instance of DeviceUsage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeviceUsage.parse_obj(obj)

        _obj = DeviceUsage.parse_obj({
            "href": obj.get("href"),
