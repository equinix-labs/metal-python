...
class SelfServiceReservationResponse(BaseModel):
    ...
    item: Optional[conlist(SelfServiceReservationItemResponse)] = None
    ...
    __properties = ["created_at", "href", "item", "notes", "organization", "organization_id", "period", "project", "project_id", "start_date", "status", "total_cost"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SelfServiceReservationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SelfServiceReservationResponse:
        """Create an instance of SelfServiceReservationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SelfServiceReservationResponse.parse_obj(obj)

        _obj = SelfServiceReservationResponse.parse_obj({
            "created_at": obj.get("created_at"),
            "href": obj.get("href"),
            "item": [SelfServiceReservationItemResponse.from_dict(_item) for _item in obj.get("item")] if obj.get("item") is not None else None,
            "notes": obj.get("notes"),
            "organization": obj.get("organization"),
            "organization_id": obj.get("organization_id"),
            "period": CreateSelfServiceReservationRequestPeriod.from_dict(obj.get("period")) if obj.get("period") is not None else None,
