...
class VrfRouteCreateInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VrfRouteCreateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VrfRouteCreateInput:
        """Create an instance of VrfRouteCreateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VrfRouteCreateInput.parse_obj(obj)

        _obj = VrfRouteCreateInput.parse_obj({
            "href": obj.get("href"),
