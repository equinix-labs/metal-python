...
class InvitationsApi(object):
    ...
    @validate_arguments
    def accept_invitation(self, id : Annotated[StrictStr, Field(..., description="Invitation UUID")], **kwargs) -> Membership:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the accept_invitation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.accept_invitation_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def accept_invitation_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Invitation UUID")], **kwargs) -> ApiResponse:  # noqa: E501
        """Accept an invitation  # noqa: E501
    ...
    def decline_invitation(self, id : Annotated[StrictStr, Field(..., description="Invitation UUID")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the decline_invitation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def decline_invitation_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Invitation UUID")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method decline_invitation" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def find_invitation_by_id(self, id : Annotated[StrictStr, Field(..., description="Invitation UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> Invitation:  # noqa: E501
        ...
        >>> thread = api.find_invitation_by_id(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the find_invitation_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.find_invitation_by_id_with_http_info(id, include, exclude, **kwargs)  # noqa: E501
    ...
    def find_invitation_by_id_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Invitation UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.find_invitation_by_id_with_http_info(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_invitation_by_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
