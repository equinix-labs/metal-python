...
class VrfCreateInput(BaseModel):
    ...
    ip_ranges: Optional[conlist(StrictStr)] = Field(None, description="A list of CIDR network addresses. Like [\"10.0.0.0/16\", \"2001:d78::/56\"]. IPv4 blocks must be between /8 and /29 in size. IPv6 blocks must be between /56 and /64. A VRF\\'s IP ranges must be defined in order to create VRF IP Reservations, which can then be used for Metal Gateways or Virtual Circuits.")
    local_asn: Optional[StrictInt] = None
    metro: StrictStr = Field(..., description="The UUID (or metro code) for the Metro in which to create this VRF.")
    name: StrictStr = Field(...)
    tags: Optional[conlist(StrictStr)] = None
    __properties = ["bgp_dynamic_neighbors_bfd_enabled", "bgp_dynamic_neighbors_enabled", "bgp_dynamic_neighbors_export_route_map", "description", "href", "ip_ranges", "local_asn", "metro", "name", "tags"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VrfCreateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VrfCreateInput:
        """Create an instance of VrfCreateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VrfCreateInput.parse_obj(obj)

        _obj = VrfCreateInput.parse_obj({
