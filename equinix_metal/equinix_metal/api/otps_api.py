...
class OTPsApi(object):
    ...
    def find_ensure_otp(self, otp : Annotated[StrictStr, Field(..., description="OTP")], **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the find_ensure_otp_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method find_ensure_otp" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def find_recovery_codes(self, **kwargs) -> RecoveryCodeList:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the find_recovery_codes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.find_recovery_codes_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def find_recovery_codes_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve my recovery codes  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_recovery_codes" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def receive_codes(self, **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the receive_codes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.receive_codes_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def receive_codes_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Receive an OTP per sms  # noqa: E501
    ...
    @validate_arguments
    def regenerate_codes(self, **kwargs) -> RecoveryCodeList:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the regenerate_codes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.regenerate_codes_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def regenerate_codes_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Generate new recovery codes  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method regenerate_codes" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
