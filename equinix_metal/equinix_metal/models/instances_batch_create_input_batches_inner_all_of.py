...
class InstancesBatchCreateInputBatchesInnerAllOf(BaseModel):
    """
    ...
    __properties = ["hostnames", "href", "quantity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstancesBatchCreateInputBatchesInnerAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstancesBatchCreateInputBatchesInnerAllOf:
        """Create an instance of InstancesBatchCreateInputBatchesInnerAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return InstancesBatchCreateInputBatchesInnerAllOf.parse_obj(obj)

        _obj = InstancesBatchCreateInputBatchesInnerAllOf.parse_obj({
