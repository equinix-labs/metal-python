...
class EmailsApi(object):
    ...
    def create_email(self, create_email_input : Annotated[CreateEmailInput, Field(..., description="Email to create")], **kwargs) -> Email:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the create_email_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def create_email_with_http_info(self, create_email_input : Annotated[CreateEmailInput, Field(..., description="Email to create")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        _body_params = None
        if _params['create_email_input'] is not None:
            _body_params = _params['create_email_input']
    ...
    def delete_email(self, id : Annotated[StrictStr, Field(..., description="Email UUID")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_email_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    @validate_arguments
    def find_email_by_id(self, id : Annotated[StrictStr, Field(..., description="Email UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> Email:  # noqa: E501
        ...
        >>> thread = api.find_email_by_id(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the find_email_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.find_email_by_id_with_http_info(id, include, exclude, **kwargs)  # noqa: E501

    @validate_arguments
    def find_email_by_id_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Email UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve an email  # noqa: E501
        ...
        >>> thread = api.find_email_by_id_with_http_info(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_email_by_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def update_email(self, id : Annotated[StrictStr, Field(..., description="Email UUID")], update_email_input : Annotated[UpdateEmailInput, Field(..., description="email to update")], **kwargs) -> Email:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the update_email_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def update_email_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Email UUID")], update_email_input : Annotated[UpdateEmailInput, Field(..., description="email to update")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['update_email_input'] is not None:
            _body_params = _params['update_email_input']
