...
class Attribute(BaseModel):
    ...
    namespace: Optional[StrictStr] = Field(None, description="Attribute namespace")
    updated_at: Optional[datetime] = Field(None, description="Datetime when the block was updated.")
    __properties = ["created_at", "data", "href", "namespace", "updated_at"]
    ...
    def from_dict(cls, obj: dict) -> Attribute:
        ...
        _obj = Attribute.parse_obj({
            ...
            "data": AttributeData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "href": obj.get("href"),
