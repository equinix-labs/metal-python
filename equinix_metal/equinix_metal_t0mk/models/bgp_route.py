...
class BgpRoute(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BgpRoute:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BgpRoute:
        """Create an instance of BgpRoute from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BgpRoute.parse_obj(obj)

        _obj = BgpRoute.parse_obj({
            "exact": obj.get("exact"),
            "href": obj.get("href"),
            "route": obj.get("route")
        })
