...
class BgpDynamicNeighborList(BaseModel):
    ...
    """
    bgp_dynamic_neighbors: Optional[conlist(BgpDynamicNeighbor)] = None
    href: Optional[StrictStr] = None
    meta: Optional[Meta] = None
    __properties = ["bgp_dynamic_neighbors", "href", "meta"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BgpDynamicNeighborList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BgpDynamicNeighborList:
        """Create an instance of BgpDynamicNeighborList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BgpDynamicNeighborList.parse_obj(obj)

        _obj = BgpDynamicNeighborList.parse_obj({
            "bgp_dynamic_neighbors": [BgpDynamicNeighbor.from_dict(_item) for _item in obj.get("bgp_dynamic_neighbors")] if obj.get("bgp_dynamic_neighbors") is not None else None,
            "href": obj.get("href"),
