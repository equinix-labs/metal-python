...
class UserCreateInput(BaseModel):
    ...
    emails: conlist(EmailInput) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserCreateInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserCreateInput:
        """Create an instance of UserCreateInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserCreateInput.parse_obj(obj)

        _obj = UserCreateInput.parse_obj({
