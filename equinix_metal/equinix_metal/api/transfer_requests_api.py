...
class TransferRequestsApi(object):
    ...
    def accept_transfer_request(self, id : Annotated[StrictStr, Field(..., description="Transfer request UUID")], **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the accept_transfer_request_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method accept_transfer_request" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def decline_transfer_request(self, id : Annotated[StrictStr, Field(..., description="Transfer request UUID")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the decline_transfer_request_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def decline_transfer_request_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Transfer request UUID")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method decline_transfer_request" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def find_transfer_request_by_id(self, id : Annotated[StrictStr, Field(..., description="Transfer request UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> TransferRequest:  # noqa: E501
        ...
        >>> thread = api.find_transfer_request_by_id(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the find_transfer_request_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.find_transfer_request_by_id_with_http_info(id, include, exclude, **kwargs)  # noqa: E501
    ...
    def find_transfer_request_by_id_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Transfer request UUID")], include : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to include. Included objects will return their full attributes. Attribute names can be dotted (up to 3 levels) to included deeply nested objects.")] = None, exclude : Annotated[Optional[conlist(StrictStr)], Field(description="Nested attributes to exclude. Excluded objects will return only the href attribute. Attribute names can be dotted (up to 3 levels) to exclude deeply nested objects.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        >>> thread = api.find_transfer_request_by_id_with_http_info(id, include, exclude, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_transfer_request_by_id" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
