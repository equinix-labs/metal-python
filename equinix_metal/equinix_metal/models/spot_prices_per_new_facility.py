...
class SpotPricesPerNewFacility(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotPricesPerNewFacility:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotPricesPerNewFacility:
        """Create an instance of SpotPricesPerNewFacility from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotPricesPerNewFacility.parse_obj(obj)

        _obj = SpotPricesPerNewFacility.parse_obj({
            "baremetal_1e": SpotPricesPerBaremetal.from_dict(obj.get("baremetal_1e")) if obj.get("baremetal_1e") is not None else None,
            "href": obj.get("href")
        })
        return _obj
