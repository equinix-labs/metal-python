...
class SpotMarketPricesPerMetroList(BaseModel):
    ...
    __properties = ["href", "spot_market_prices"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotMarketPricesPerMetroList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotMarketPricesPerMetroList:
        """Create an instance of SpotMarketPricesPerMetroList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotMarketPricesPerMetroList.parse_obj(obj)

        _obj = SpotMarketPricesPerMetroList.parse_obj({
            "href": obj.get("href"),
            "spot_market_prices": SpotMarketPricesPerMetroReport.from_dict(obj.get("spot_market_prices")) if obj.get("spot_market_prices") is not None else None
        })
        return _obj
