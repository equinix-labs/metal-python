...
class PaymentMethodList(BaseModel):
    ...
    payment_methods: Optional[conlist(PaymentMethod)] = None
    __properties = ["href", "payment_methods"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentMethodList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentMethodList:
        """Create an instance of PaymentMethodList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentMethodList.parse_obj(obj)

        _obj = PaymentMethodList.parse_obj({
            "href": obj.get("href"),
