...
class ProjectUsage(BaseModel):
    ...
    __properties = ["facility", "href", "name", "plan", "plan_version", "price", "quantity", "total", "type", "unit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectUsage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectUsage:
        """Create an instance of ProjectUsage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectUsage.parse_obj(obj)

        _obj = ProjectUsage.parse_obj({
