...
class MetadataNetworkNetworkBonding(BaseModel):
    ...
    __properties = ["href", "link_aggregation", "mac", "mode"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MetadataNetworkNetworkBonding:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MetadataNetworkNetworkBonding:
        """Create an instance of MetadataNetworkNetworkBonding from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MetadataNetworkNetworkBonding.parse_obj(obj)

        _obj = MetadataNetworkNetworkBonding.parse_obj({
            "href": obj.get("href"),
