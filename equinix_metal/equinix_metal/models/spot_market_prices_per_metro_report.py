...
class SpotMarketPricesPerMetroReport(BaseModel):
    ...
    __properties = ["am", "ch", "da", "href", "la", "ny", "sg", "sv"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotMarketPricesPerMetroReport:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotMarketPricesPerMetroReport:
        """Create an instance of SpotMarketPricesPerMetroReport from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotMarketPricesPerMetroReport.parse_obj(obj)

        _obj = SpotMarketPricesPerMetroReport.parse_obj({
            "am": SpotPricesPerFacility.from_dict(obj.get("am")) if obj.get("am") is not None else None,
            "ch": SpotPricesPerFacility.from_dict(obj.get("ch")) if obj.get("ch") is not None else None,
            "da": SpotPricesPerFacility.from_dict(obj.get("da")) if obj.get("da") is not None else None,
            "href": obj.get("href"),
            "la": SpotPricesPerFacility.from_dict(obj.get("la")) if obj.get("la") is not None else None,
            "ny": SpotPricesPerFacility.from_dict(obj.get("ny")) if obj.get("ny") is not None else None,
            "sg": SpotPricesPerFacility.from_dict(obj.get("sg")) if obj.get("sg") is not None else None,
            "sv": SpotPricesPerFacility.from_dict(obj.get("sv")) if obj.get("sv") is not None else None
        })
        return _obj
