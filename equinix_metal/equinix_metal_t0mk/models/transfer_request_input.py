...
class TransferRequestInput(BaseModel):
    ...
    __properties = ["href", "target_organization_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferRequestInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferRequestInput:
        """Create an instance of TransferRequestInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferRequestInput.parse_obj(obj)

        _obj = TransferRequestInput.parse_obj({
            "href": obj.get("href"),
