...
class SpotMarketPricesList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotMarketPricesList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotMarketPricesList:
        """Create an instance of SpotMarketPricesList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotMarketPricesList.parse_obj(obj)

        _obj = SpotMarketPricesList.parse_obj({
            "href": obj.get("href"),
            "spot_market_prices": SpotPricesReport.from_dict(obj.get("spot_market_prices")) if obj.get("spot_market_prices") is not None else None
        })
        return _obj
